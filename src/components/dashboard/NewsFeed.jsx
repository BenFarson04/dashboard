...
export function NewsFeed({ full = false }) {
  ...
  return (
    <Card title="Personalised news" icon="Newspaper" labelledBy="news-title"
      ...
      <p className="mb-2 inline-flex items-center gap-1 rounded-md bg-amber-50 px-2 py-1 text-[11px] font-medium text-amber-700 dark:bg-amber-950/40 dark:text-amber-300">
      ...
      <StateBoundary
        ...
        emptyProps={{ icon: 'Newspaper', title: 'No articles', message: savedOnly ? 'You haven’t saved anything yet.' : 'No stories match your selected topics.' }}
      >
